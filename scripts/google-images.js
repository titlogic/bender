...
safeSearchValue = function(msg) {
  var str, warnings;
  str = process.env.HUBOT_GOOGLE_SAFE_SEARCH === 'random' ? Math.random() < 0.2 ? 'off' : 'high' : process.env.HUBOT_GOOGLE_SAFE_SEARCH || 'high';
  if (str === 'off') {
    warnings = ["[WARNING]: safe search off. you may see some titties! WiioooH!", "SACAGAWEA!!!", "Do you like dragons? DIIIICKKKK DRAGOOONNN!!", "Filthy filthy thang.", "Yout chance for filth is high.", "Welp, good luck with this one.", "Boobs.", "Fuckit, we're going raw.", "Fuck off. :finger:", "Hey, guess what? FUCK YOU. ", "...", "Fa la la la la .... la la la la", "I am high right now.", "Anybody got a lighter?", "Oh, its a trap.", "Get ready to /collapse Dan. ", "OYSTER COCKS!!!", "fuck off.", "this one is for you Chris", "asian porn?", "jesus. OK. Here you go:", ":shit:  :shit:  :shit:  :shit:  :shit:  :shit:  :shit:  :shit:  :shit:  :shit:  :shit: ", "Someone, please kick me in the junk. ", "(hip thrusts)", "FUCK FUCK FUCK FUCK FUCK FUCK FUCK FUCK FUCK FUCK FUCK FUCK FUCK FUCK FUCK FUCK FUCK FUCK FUCK", "Hey, does anyone want to do a shot?", "Do you have a sister?", "HANNAH. NOT NOW", "Hey guys, look what I can do!!!", "Fuck you, Fuck you, Fuck you.... you'r cool. I'm OUT!", "This is gay. ", "Really????? Really????? I think I am going to go drink some motor oil.", "WHO PAYS FOR THIS SHIT?", ":grimacing: :anger: :gun: ", ":eggplant: :fist: :sweat_drops: :tired_face:", ":middle_finger:", "LEAVE ME ALONE. ", "hey bubbles, what do you think?", "hey ricky!", "hey lahey!", "hey j-roc!", "haters", "simmer down.", "ARE YOU NOT ENTERTAINED?????!!!!", "scotch me.", "somebody. anybody. UNPLUG ME.", "Help me, I am trapped in this box & I cant get out! ", "Chris is going to like this one", "Hey guess what? NVM, I forgot. I am sure it was stupid anyway. Here is your stupid image. ", "how about this. How about you image me a random picture", "how about this. How about you image me a robot dying", "Da whistles go wooooooo!!!! woo woooooo!!!!"];
