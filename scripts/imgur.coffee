...
module.exports = (robot) ->
  ...
  termToGaleries = (term) ->
    galleries = if /\b(ass)\b/.test(term)
      ...
      ["collegesluts", 'HairyPussy', 'rearpussy', 'LabiaGW', 'upskirts', 'grool', 'wifesharing', 'Innie', 'simps']
